...
import ballboy.model.snapshot.ControllableDynamicEnitySnapshot;
...
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity {
    ...
    private ControllableDynamicEnitySnapshot entityBackup;
    ...
    public void backup(){
        ...
        this.entityBackup = new ControllableDynamicEnitySnapshot(this, entity);
