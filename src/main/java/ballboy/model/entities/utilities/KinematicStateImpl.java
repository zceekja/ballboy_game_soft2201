...
import ballboy.model.snapshot.KinematicStateSnapshot;
...
public class KinematicStateImpl implements KinematicState {
    ...
    private KinematicStateSnapshot save;
    ...
    public void load(Vector2D position, Vector2D previousPosition, Vector2D velocity, double horizontalAcceleration){
        this.position = position;
        this.previousPosition = previousPosition;
        this.velocity = velocity;
        this.horizontalAcceleration =horizontalAcceleration;
    ...
    public void backup(){
        save = new KinematicStateSnapshot(this, position, previousPosition, velocity, horizontalAcceleration);
    }
}
