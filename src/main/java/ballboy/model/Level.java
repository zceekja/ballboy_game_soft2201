...
public interface Level {
    ...
    int getCurrentLevel();
     /**
      * @param entity The entity to be checked.
     * Check wether Enity is enemy or not
     */
    boolean isEnemy(Entity entity);

     /**
      * @param entity The entity to be checked.
     * If entity is Enemy, Remove it from list.
     */
    void killEnemy(Entity entity);

    /**
      * @param gm The GameEngine to be store.
     *  Settter method to store game engine
     */
    void setGM(GameEngine gm);
        /**
      * @param o Observer to register.
     *  register observer, add it to list of observer
     */
    ...
    /**
      * @param entity Entity to sent to all observers.
     *  notify all observer.
     */
    ...
    void restore();
        /**
      * save Snapshot of level
     */
    void backup();

    /**
      * set entities from snapshot
     */
    void setEntities(List<Entity> entities, int game_end);
    /**
      * check whter game is ended or not
     */
    int isGameEnd();
}
